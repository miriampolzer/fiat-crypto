...
Section Compile.
  ...
  Hint Extern 1 (Lift1Prop.impl1 (Field.FElem ?px ?x) (_)) => (epose proof (iff1ToEq (felem_to_bytes _ _)) as ?HF;
      rewrite HF; clear HF; exact impl1_refl) : ecancel_impl. (* TODO can this be simplified?*)
