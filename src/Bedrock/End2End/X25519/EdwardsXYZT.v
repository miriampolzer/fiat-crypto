...
Proof.
  ...
  { (* Correctness: result matches Gallina *)
    destruct p, c.
    cbv [bin_model bin_mul bin_add bin_carry_add bin_sub coordinates proj1_sig precomputed_coordinates] in *.
    cbv match beta zeta delta [m1add_precomputed_coordinates coordinates proj1_sig].
    destruct_head' prod.
    congruence.
  }
