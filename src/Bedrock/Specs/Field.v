...
(* I'm in danger to make everything a notation now. This way straightline tactics can see the anybytes
   and resolve it without needed any intermediate steps. This is weird, isn't it? We use a notation
   for a kind "transparent" definition. Probably not quite the intention, and I'm sure it comes
   with downsides... *)
